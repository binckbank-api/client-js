 ...
 */
function handleAuthenticationResponse($isRefresh, $realm, $code, $redirect_uri) {
    global $configuration;
    if ($isRefresh == true) {
...
} elseif (isset($_GET['realm']) && isset($_GET['code']) && isset($_GET['redirect_uri'])) {
